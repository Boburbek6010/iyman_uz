...
import 'package:iyman_uz/features/taxorat/presentation/widgets/taxorats_widgets.dart';

import '../../../../../core/colors/app_color.dart';


class ErkaklarTaxoratOlishTartibi extends StatelessWidget {
  const ErkaklarTaxoratOlishTartibi({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        title: const Text("Erkaklar Taxorat Olish Tartibi",),
        centerTitle: true,
